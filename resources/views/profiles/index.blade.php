@extends('layouts.dashboard', ['page_title' => 'manajemen profil pengguna'])
@section('content')
	<p class="lead">
		Di sini kamu dapat mengatur profil dari pengguna aplikasi ini.
		Kamu dapat melihat profil yang terdaftar, menambahkan profil,
		dan memperbarui informasi profil.
	</p>
	@component('components.panel',
	['context'    => '',
	'panel_title' => 'daftar profil pengguna'])
		<div style="margin-bottom: 2em;">
			<button class="btn btn-primary btn-model-add" data-toggle="modal" data-target="#modal-add-profile">
				<span class="fa fa-plus"></span>
				{{ ucwords(__('tambah profil')) }}
			</button>
		</div>
	...
	@endcomponent
	<p>
		Kamu dapat mengkaitkan profil dengan akun pengguna.
		Perlu kamu ketahui, kamu harus membuat akun pengguna
		terlebih dahulu sebelum bisa mengkaitkan akun
		dengan profil. Untuk membuat akun, gunakan
		<a href="{{ route('users.index') }}">modul manajemen pengguna</a>.
	</p>
@endsection
@push('vendorstyles')
		...
		$(document).ready(function() {
			...
			function handleRoleCheckboxesOnChange(form) {
				...
				$.ajax({
					...
					method: 'post',
					data: { 'role_ids' : checked_roles_add, },
					success: function(response) {
