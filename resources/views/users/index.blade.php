...
<section class="panel">
	...
	<div class="panel-body">
		<button type="button" class="btn btn-primary btn-modal-add" data-toggle="modal" data-target="#modal-add-user">Tambah</button>
		...
		function fetch_profiles(form, selected,text_selected){
			$.ajax({
				...
				success: function(response){
					...
					$('select[name="profile_id"]', form).append($('<option value="">Profile ...</option>'));
