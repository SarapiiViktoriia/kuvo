(function() {
  ...
  MT("test namespaced variable",
     "[keyword declare] [keyword namespace] [variable e] [keyword =] [string \"http:
  MT("test EQName variable",
     "[keyword declare] [keyword variable] [variable $\"http:
     "[tag <out>]{[variable $\"http:
  MT("test EQName function",
     "[keyword declare] [keyword function] [def&variable \"http:
     "   [variable $a] [keyword +] [atom 2]",
     "}[variable ;]",
     "[tag <out>]{[def&variable \"http:
